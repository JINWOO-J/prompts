...
source: '[Scoutflo/Scoutflo-SRE-Playbooks](https://github.com/Scoutflo/Scoutflo-SRE-Playbooks/blob/master/AWS%20Playbooks/01-Compute/Not-Launching-New-Instances-Auto-Scaling.md)'
...
# Auto Scaling이 새 인스턴스를 시작하지 않음 (Not Launching New Instances)
